...
export declare function ctcDecoder(padToken?: string = '<pad>', wordDelimiterToken?: string | undefined | null, cleanup?: boolean | undefined | null): Decoder
export declare function fuseDecoder(): Decoder
export declare function metaspaceDecoder(replacement?: string = '▁', addPrefixSpace?: bool = true): Decoder
...
export declare function stripNormalizer(left?: boolean | undefined | null, right?: boolean | undefined | null): Normalizer
...
export declare function byteLevelPreTokenizer(addPrefixSpace?: boolean | undefined | null, useRegex?: boolean | undefined | null): PreTokenizer
...
export declare function metaspacePreTokenizer(replacement?: string = '▁', addPrefixSpace?: bool = true): PreTokenizer
export declare function splitPreTokenizer(pattern: string, behavior: string, invert?: boolean | undefined | null): PreTokenizer
...
export declare function robertaProcessing(sep: [string, number], cls: [string, number], trimOffsets?: boolean | undefined | null, addPrefixSpace?: boolean | undefined | null): Processor
export declare function byteLevelProcessing(trimOffsets?: boolean | undefined | null): Processor
export declare function templateProcessing(single: string, pair?: string | undefined | null, specialTokens?: Array<[string, number]> | undefined | null): Processor
...
export declare function slice(s: string, beginIndex?: number | undefined | null, endIndex?: number | undefined | null): string
export declare function mergeEncodings(encodings: Array<Encoding>, growingOffsets?: boolean | undefined | null): Encoding
/** Decoder */
